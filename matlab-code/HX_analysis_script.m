    ...
    if min(ismember(session,unique(hexa_data.session_n)))==1
            ...
            for a4 = a4_vec
                for a5 = a5_vec
                    ...
                    if find(a5==a5_vec)==numel(a5_vec)
                        ...
                        imagesc(squeeze(opt_LL_tensor(find(a2==a2_vec),:,:)),[1.5 2.5]); colormap(exag_map);
                        title('nLL');
        ...
        %----------------------------------------
           ...
           % interim visualization
            ...
            eval(['save ~/Downloads/' all_files(mmm).name(1:end-4) '_sess' num2str(session) '_opt.mat a* opt* dopa tot_rew vis_prob vis_obs']);
