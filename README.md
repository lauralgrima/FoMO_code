...
The main-analysis-code folder contains scripts with functions to generate manuscript figures. All analysis code is in Python 3, and all required packages should come by default with the Anaconda Python distribution. 
